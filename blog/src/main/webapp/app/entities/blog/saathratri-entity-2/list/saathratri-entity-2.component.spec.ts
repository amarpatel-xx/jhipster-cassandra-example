...
describe('SaathratriEntity2 Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ entityTypeId: '9fec3727-3421-4967-b213-ba36557ca194' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ entityTypeId: '1361f429-3817-4123-8ee3-fdf8943310b2' }],
            headers: new HttpHeaders({
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.saathratriEntity2s?.[0]).toEqual(expect.objectContaining({ entityTypeId: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });

  describe('trackEntityTypeId', () => {
    it('Should forward to saathratriEntity2Service', () => {
      const entity = { entityTypeId: '9fec3727-3421-4967-b213-ba36557ca194' };
