...
import { SaathratriEntity4DeleteDialogComponent } from './saathratri-entity-4-delete-dialog.component';
...
describe('SaathratriEntity4 Management Delete Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [SaathratriEntity4DeleteDialogComponent],
      providers: [provideHttpClient(), NgbActiveModal],
    })
      .overrideTemplate(SaathratriEntity4DeleteDialogComponent, '')
      .compileComponents();
