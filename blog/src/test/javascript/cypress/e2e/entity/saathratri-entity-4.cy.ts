...
describe('SaathratriEntity4 e2e test', () => {
  ...
  describe('new SaathratriEntity4 page', () => {
    ...
    it('should create an instance of SaathratriEntity4', () => {
      cy.get(`[data-cy="attributeKey"]`).type('ouch opera gifted');
      cy.get(`[data-cy="attributeKey"]`).should('have.value', 'ouch opera gifted');

      cy.get(`[data-cy="attributeValue"]`).type('blah cumbersome whoever');
      cy.get(`[data-cy="attributeValue"]`).should('have.value', 'blah cumbersome whoever');
