...
describe('LandingPageByOrganization e2e test', () => {
  ...
  describe('new LandingPageByOrganization page', () => {
    ...
    it('should create an instance of LandingPageByOrganization', () => {
      cy.get(`[data-cy="detailsText"]`).type('incidentally');
      cy.get(`[data-cy="detailsText"]`).should('have.value', 'incidentally');

      cy.get(`[data-cy="detailsDecimal"]`).type('15549.99');
      cy.get(`[data-cy="detailsDecimal"]`).should('have.value', '15549.99');
      ...
      cy.get(`[data-cy="detailsBigInt"]`).type('23965');
      cy.get(`[data-cy="detailsBigInt"]`).should('have.value', '23965');
