...
public class SaathratriEntity5Asserts {
    ...
    public static void assertSaathratriEntity5AllUpdatablePropertiesEquals(SaathratriEntity5 expected, SaathratriEntity5 actual) {
        ...
        assertSaathratriEntity5UpdatableRelationshipsEquals(expected, actual);
    }
    ...
    public static void assertSaathratriEntity5UpdatableFieldsEquals(SaathratriEntity5 expected, SaathratriEntity5 actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getAddOnId()).as("check addOnId").isEqualTo(actual.getAddOnId()))
     ...
     * @param actual the actual entity
     */
    public static void assertSaathratriEntity5UpdatableRelationshipsEquals(SaathratriEntity5 expected, SaathratriEntity5 actual) {
        // empty method
    }
}
