...
class SaathratriEntity4DTOTest {
    ...
    void dtoEqualsVerifier() throws Exception {
        ...
        saathratriEntity4DTO1.setCompositeId(new SaathratriEntity4DTOId(UUID.randomUUID(), 1L));
        ...
        saathratriEntity4DTO2.setCompositeId(new SaathratriEntity4DTOId(UUID.randomUUID(), 1L));
        assertThat(saathratriEntity4DTO1).isNotEqualTo(saathratriEntity4DTO2);
