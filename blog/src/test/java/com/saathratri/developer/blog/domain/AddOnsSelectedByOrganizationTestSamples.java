...
public class AddOnsSelectedByOrganizationTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));

    public static AddOnsSelectedByOrganization getAddOnsSelectedByOrganizationSample1() {
        return new AddOnsSelectedByOrganization()
            .compositeId(
    ...
    public static AddOnsSelectedByOrganization getAddOnsSelectedByOrganizationSample2() {
        return new AddOnsSelectedByOrganization()
            .compositeId(
                new AddOnsSelectedByOrganizationId()
    ...
    public static AddOnsSelectedByOrganization getAddOnsSelectedByOrganizationRandomSampleGenerator() {
        return new AddOnsSelectedByOrganization()
            .compositeId(
                new AddOnsSelectedByOrganizationId()
