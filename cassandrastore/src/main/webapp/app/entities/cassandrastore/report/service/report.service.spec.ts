...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../report.test-samples';
...
describe('Report Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Report', () => {
      ...
      service.create(report).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Report', () => {
      ...
      service.update(report).subscribe(resp => (expectedResult = resp));
    ...
    describe('addReportToCollectionIfMissing', () => {
      it('should add a Report to an empty array', () => {
        ...
        expect(expectedResult).toEqual([report]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([report, report2]);
      });
    ...
    describe('compareReport', () => {
      ...
      it('should return false if one entity is null', () => {
        const entity1 = { id: 'e885ed53-a9f8-46c5-9db7-aa4b52344422' };
        const entity2 = null;
      ...
      it('should return false if primaryKey differs', () => {
        const entity1 = { id: 'e885ed53-a9f8-46c5-9db7-aa4b52344422' };
        const entity2 = { id: '4dddf5e7-444e-42ae-bf41-a8a5c3c01676' };
      ...
      it('should return false if primaryKey matches', () => {
        const entity1 = { id: 'e885ed53-a9f8-46c5-9db7-aa4b52344422' };
        const entity2 = { id: 'e885ed53-a9f8-46c5-9db7-aa4b52344422' };
