...
class SaathratriEntity3DTOTest {
    ...
    void dtoEqualsVerifier() throws Exception {
        ...
        saathratriEntity3DTO1.setCompositeId(new SaathratriEntity3DTOId(UUID.randomUUID().toString(), UUID.randomUUID()));
        ...
        saathratriEntity3DTO2.setCompositeId(new SaathratriEntity3DTOId(UUID.randomUUID().toString(), UUID.randomUUID()));
        assertThat(saathratriEntity3DTO1).isNotEqualTo(saathratriEntity3DTO2);
