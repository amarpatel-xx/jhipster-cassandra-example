...
public class SaathratriEntity2ServiceImpl implements SaathratriEntity2Service {
    ...
    @Override
    public Slice<SaathratriEntity2DTO> findAllByCompositeIdEntityTypeIdPageable(final UUID entityTypeId, Pageable pageable) {
        LOG.debug("Request to findAllByCompositeIdEntityTypeIdPageable service in SaathratriEntity2ServiceImpl with pagination.");
        return saathratriEntity2Repository.findAllByCompositeIdEntityTypeId(entityTypeId, pageable).map(saathratriEntity2Mapper::toDto);
    }
    ...
    @Override
    public Slice<SaathratriEntity2DTO> findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedPageable(
        final UUID entityTypeId,
        final Long yearOfDateAdded,
        Pageable pageable
    ) {
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedPageable service in SaathratriEntity2ServiceImpl with pagination."
        );
        return saathratriEntity2Repository
    ...
    @Override
    public Slice<SaathratriEntity2DTO> findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDatePageable(
        final UUID entityTypeId,
        final Long yearOfDateAdded,
        final Long arrivalDate,
        Pageable pageable
        ...
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDatePageable service in SaathratriEntity2ServiceImpl with pagination."
        );
        return saathratriEntity2Repository
            .findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDate(
                entityTypeId,
    ...
    > findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateLessThanPageable(
        ...
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateLessThanPageable service in SaathratriEntity2ServiceImpl with pagination."
        );
        return saathratriEntity2Repository
            .findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateLessThan(
                entityTypeId,
    ...
    public List<SaathratriEntity2DTO> findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateLessThanEqual(
        ...
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateLessThanEqual(final UUID entityTypeId, final Long yearOfDateAdded, final Long arrivalDate) service in SaathratriEntity2ServiceImpl."
        );
        return saathratriEntity2Repository
    ...
    > findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateLessThanEqualPageable(
        ...
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateLessThanEqualPageable service in SaathratriEntity2ServiceImpl with pagination."
        );
        return saathratriEntity2Repository
            .findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateLessThanEqual(
                entityTypeId,
    ...
    > findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateGreaterThanPageable(
        ...
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateGreaterThanPageable service in SaathratriEntity2ServiceImpl with pagination."
        );
        return saathratriEntity2Repository
            .findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateGreaterThan(
                entityTypeId,
    ...
    > findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateGreaterThanEqual(
        ...
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateGreaterThanEqual(final UUID entityTypeId, final Long yearOfDateAdded, final Long arrivalDate) service in SaathratriEntity2ServiceImpl."
        );
        return saathratriEntity2Repository
            .findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateGreaterThanEqual(
                entityTypeId,
    ...
    > findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateGreaterThanEqualPageable(
        ...
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateGreaterThanEqualPageable service in SaathratriEntity2ServiceImpl with pagination."
        );
        return saathratriEntity2Repository
            .findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateGreaterThanEqual(
                entityTypeId,
    ...
    > findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdLessThanPageable(
        ...
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdLessThanPageable service in SaathratriEntity2ServiceImpl with pagination."
        );
        return saathratriEntity2Repository
            .findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdLessThan(
                entityTypeId,
    ...
    > findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdLessThanEqual(
        ...
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdLessThanEqual(final UUID entityTypeId, final Long yearOfDateAdded, final Long arrivalDate, final UUID blogId) service in SaathratriEntity2ServiceImpl."
        );
        return saathratriEntity2Repository
            .findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdLessThanEqual(
                entityTypeId,
    ...
    > findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdLessThanEqualPageable(
        ...
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdLessThanEqualPageable service in SaathratriEntity2ServiceImpl with pagination."
        );
        return saathratriEntity2Repository
            .findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdLessThanEqual(
                entityTypeId,
    ...
    > findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdGreaterThanPageable(
        ...
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdGreaterThanPageable service in SaathratriEntity2ServiceImpl with pagination."
        );
        return saathratriEntity2Repository
            .findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdGreaterThan(
                entityTypeId,
    ...
    > findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdGreaterThanEqual(
        ...
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdGreaterThanEqual(final UUID entityTypeId, final Long yearOfDateAdded, final Long arrivalDate, final UUID blogId) service in SaathratriEntity2ServiceImpl."
        );
        return saathratriEntity2Repository
            .findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdGreaterThanEqual(
                entityTypeId,
    ...
    > findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdGreaterThanEqualPageable(
        ...
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdGreaterThanEqualPageable service in SaathratriEntity2ServiceImpl with pagination."
        );
        return saathratriEntity2Repository
            .findAllByCompositeIdEntityTypeIdAndCompositeIdYearOfDateAddedAndCompositeIdArrivalDateAndCompositeIdBlogIdGreaterThanEqual(
                entityTypeId,
