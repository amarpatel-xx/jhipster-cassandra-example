...
public class LandingPageByOrganizationResource {
    ...
    private static final String ENTITY_NAME = "cassandrablogLandingPageByOrganization";
    ...
    /**
     * {@code GET  /landing-page-by-organizations/slice} : get landingPageByOrganizations with Cassandra cursor-based pagination.
     *
     ...
     */
    @GetMapping("/slice")
    public ResponseEntity<List<LandingPageByOrganizationDTO>> getAllLandingPageByOrganizationsSlice(
        @RequestParam(name = "pagingState", required = false) String pagingState,
        @RequestParam(name = "size", defaultValue = "20") int size
    ) {
        LOG.debug("REST request to get a slice of LandingPageByOrganizations, pagingState: {}, size: {}", pagingState, size);
        ...
        Slice<LandingPageByOrganizationDTO> slice = landingPageByOrganizationService.findAllSlice(cassandraPageRequest);
        List<LandingPageByOrganizationDTO> result = slice.getContent();
