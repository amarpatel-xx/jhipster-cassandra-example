...
public class SaathratriEntity4ServiceImpl implements SaathratriEntity4Service {
    ...
    @Override
    public Slice<SaathratriEntity4DTO> findAllSlice(org.springframework.data.domain.Pageable pageable) {
        LOG.debug("Request to get a slice of SaathratriEntity4s");
        return saathratriEntity4Repository.findAll(pageable).map(saathratriEntity4Mapper::toDto);
    }
    ...
    @Override
    public Slice<SaathratriEntity4DTO> findAllByCompositeIdOrganizationIdPageable(final UUID organizationId, Pageable pageable) {
        LOG.debug("Request to findAllByCompositeIdOrganizationIdPageable service in SaathratriEntity4ServiceImpl with pagination.");
        return saathratriEntity4Repository.findAllByCompositeIdOrganizationId(organizationId, pageable).map(saathratriEntity4Mapper::toDto);
    }
