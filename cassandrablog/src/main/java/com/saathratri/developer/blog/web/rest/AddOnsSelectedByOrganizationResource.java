...
public class AddOnsSelectedByOrganizationResource {
    ...
    /**
     * {@code GET  /add-ons-selected-by-organizations/slice} : get addOnsSelectedByOrganizations with Cassandra cursor-based pagination.
     *
     ...
     */
    @GetMapping("/slice")
    public ResponseEntity<List<AddOnsSelectedByOrganizationDTO>> getAllAddOnsSelectedByOrganizationsSlice(
        @RequestParam(name = "pagingState", required = false) String pagingState,
        @RequestParam(name = "size", defaultValue = "20") int size
    ) {
        LOG.debug("REST request to get a slice of AddOnsSelectedByOrganizations, pagingState: {}, size: {}", pagingState, size);
        ...
        Slice<AddOnsSelectedByOrganizationDTO> slice = addOnsSelectedByOrganizationService.findAllSlice(cassandraPageRequest);
        List<AddOnsSelectedByOrganizationDTO> result = slice.getContent();
