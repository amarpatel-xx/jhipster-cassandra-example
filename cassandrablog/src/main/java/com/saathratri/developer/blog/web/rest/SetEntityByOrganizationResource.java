...
public class SetEntityByOrganizationResource {
    ...
    private static final String ENTITY_NAME = "cassandrablogSetEntityByOrganization";
    ...
    /**
     * {@code GET  /set-entity-by-organizations/slice} : get setEntityByOrganizations with Cassandra cursor-based pagination.
     *
     ...
     */
    @GetMapping("/slice")
    public ResponseEntity<List<SetEntityByOrganizationDTO>> getAllSetEntityByOrganizationsSlice(
        @RequestParam(name = "pagingState", required = false) String pagingState,
        @RequestParam(name = "size", defaultValue = "20") int size
    ) {
        LOG.debug("REST request to get a slice of SetEntityByOrganizations, pagingState: {}, size: {}", pagingState, size);
        ...
        Slice<SetEntityByOrganizationDTO> slice = setEntityByOrganizationService.findAllSlice(cassandraPageRequest);
        List<SetEntityByOrganizationDTO> result = slice.getContent();
