...
public class SaathratriEntity3ServiceImpl implements SaathratriEntity3Service {
    ...
    @Override
    public Slice<SaathratriEntity3DTO> findAllByCompositeIdEntityTypePageable(final String entityType, Pageable pageable) {
        LOG.debug("Request to findAllByCompositeIdEntityTypePageable service in SaathratriEntity3ServiceImpl with pagination.");
        return saathratriEntity3Repository.findAllByCompositeIdEntityType(entityType, pageable).map(saathratriEntity3Mapper::toDto);
    }
    ...
    @Override
    public Slice<SaathratriEntity3DTO> findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdLessThanPageable(
        final String entityType,
        final UUID createdTimeId,
        Pageable pageable
    ) {
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdLessThanPageable service in SaathratriEntity3ServiceImpl with pagination."
        );
        return saathratriEntity3Repository
    ...
    public List<SaathratriEntity3DTO> findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdLessThanEqual(
        ...
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdLessThanEqual(final String entityType, final UUID createdTimeId) service in SaathratriEntity3ServiceImpl."
        );
        return saathratriEntity3Repository
    ...
    @Override
    public Slice<SaathratriEntity3DTO> findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdLessThanEqualPageable(
        final String entityType,
        final UUID createdTimeId,
        Pageable pageable
    ) {
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdLessThanEqualPageable service in SaathratriEntity3ServiceImpl with pagination."
        );
        return saathratriEntity3Repository
    ...
    @Override
    public Slice<SaathratriEntity3DTO> findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdGreaterThanPageable(
        final String entityType,
        final UUID createdTimeId,
        Pageable pageable
    ) {
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdGreaterThanPageable service in SaathratriEntity3ServiceImpl with pagination."
        );
        return saathratriEntity3Repository
    ...
    public List<SaathratriEntity3DTO> findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdGreaterThanEqual(
        ...
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdGreaterThanEqual(final String entityType, final UUID createdTimeId) service in SaathratriEntity3ServiceImpl."
        );
        return saathratriEntity3Repository
    ...
    @Override
    public Slice<SaathratriEntity3DTO> findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdGreaterThanEqualPageable(
        final String entityType,
        final UUID createdTimeId,
        Pageable pageable
    ) {
        LOG.debug(
            "Request to findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdGreaterThanEqualPageable service in SaathratriEntity3ServiceImpl with pagination."
        );
        return saathratriEntity3Repository
