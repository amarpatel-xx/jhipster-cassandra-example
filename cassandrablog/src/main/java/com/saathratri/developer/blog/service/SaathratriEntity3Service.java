...
public interface SaathratriEntity3Service {
    ...
    Slice<SaathratriEntity3DTO> findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdLessThanPageable(
        final String entityType,
        final UUID createdTimeId,
        Pageable pageable
    );
    List<SaathratriEntity3DTO> findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdLessThanEqual(
        final String entityType,
        final UUID createdTimeId
    );
    Slice<SaathratriEntity3DTO> findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdLessThanEqualPageable(
        final String entityType,
        final UUID createdTimeId,
        Pageable pageable
    );
    ...
    Slice<SaathratriEntity3DTO> findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdGreaterThanPageable(
        final String entityType,
        final UUID createdTimeId,
        Pageable pageable
    );
    List<SaathratriEntity3DTO> findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdGreaterThanEqual(
        final String entityType,
        final UUID createdTimeId
    );
    Slice<SaathratriEntity3DTO> findAllByCompositeIdEntityTypeAndCompositeIdCreatedTimeIdGreaterThanEqualPageable(
        final String entityType,
        final UUID createdTimeId,
        Pageable pageable
    );
