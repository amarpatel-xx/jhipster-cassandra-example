...
public class PostResource {
    ...
    private static final String ENTITY_NAME = "cassandrablogPost";
    ...
    /**
     * {@code GET  /posts/slice} : get posts with Cassandra cursor-based pagination.
     *
    ...
    public ResponseEntity<List<PostDTO>> getAllPostsSlice(
        ...
        LOG.debug("REST request to get a slice of Posts, pagingState: {}, size: {}", pagingState, size);
        ...
        Slice<PostDTO> slice = postService.findAllSlice(cassandraPageRequest);
        List<PostDTO> result = slice.getContent();
    ...
    public ResponseEntity<List<PostDTO>> findAllByCompositeIdCreatedDatePageable(
        @RequestParam(name = "createdDate", required = true) final Long createdDate,
        @RequestParam(name = "pagingState", required = false) String pagingState,
        @RequestParam(name = "size", defaultValue = "20") int size
    ) {
        LOG.debug(
            "REST request to get paginated Posts with parameters createdDate: {}, pagingState: {}, size: {}",
            createdDate,
            pagingState,
            size
        );
        ...
        if (pagingState == null || pagingState.isEmpty()) {
            ...
            try {
                ...
                LOG.error("Invalid paging state for Posts", e);
                cassandraPageRequest = CassandraPageRequest.first(size);
            }
        }

        Slice<PostDTO> slice = postService.findAllByCompositeIdCreatedDatePageable(createdDate, cassandraPageRequest);
        ...
        if (hasNext && nextPagingState == null) {
            try {
                ...
                LOG.warn("Unable to resolve next paging state for Posts", e);
            }
        }
    ...
    public ResponseEntity<List<PostDTO>> findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimePageable(
        @RequestParam(name = "createdDate", required = true) final Long createdDate,
        @RequestParam(name = "addedDateTime", required = true) final Long addedDateTime,
        @RequestParam(name = "pagingState", required = false) String pagingState,
        @RequestParam(name = "size", defaultValue = "20") int size
        ...
        LOG.debug(
            "REST request to get paginated Posts with parameters createdDate: {}, addedDateTime: {}, pagingState: {}, size: {}",
            createdDate,
            addedDateTime,
            pagingState,
            size
        ...
        Slice<PostDTO> slice = postService.findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimePageable(
            createdDate,
            addedDateTime,
    ...
    public ResponseEntity<List<PostDTO>> findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeLessThanPageable(
        @RequestParam(name = "createdDate", required = true) final Long createdDate,
        @RequestParam(name = "addedDateTime", required = true) final Long addedDateTime,
        @RequestParam(name = "pagingState", required = false) String pagingState,
        @RequestParam(name = "size", defaultValue = "20") int size
        ...
        Slice<PostDTO> slice = postService.findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeLessThanPageable(
            createdDate,
            addedDateTime,
            cassandraPageRequest
        );
    ...
    public List<PostDTO> findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeLessThanEqual(
        @RequestParam(name = "createdDate", required = true) final Long createdDate,
        @RequestParam(name = "addedDateTime", required = true) final Long addedDateTime
    ) {
        // Composite Primary Key Code
        LOG.debug(
            "REST request to findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeLessThanEqual method for Posts with parameteres createdDate: {}, addedDateTime: {}",
            createdDate,
            addedDateTime
        );
        return postService.findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeLessThanEqual(createdDate, addedDateTime);
    }
    ...
    public ResponseEntity<List<PostDTO>> findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeLessThanEqualPageable(
        @RequestParam(name = "createdDate", required = true) final Long createdDate,
        @RequestParam(name = "addedDateTime", required = true) final Long addedDateTime,
        @RequestParam(name = "pagingState", required = false) String pagingState,
        @RequestParam(name = "size", defaultValue = "20") int size
        ...
        Slice<PostDTO> slice = postService.findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeLessThanEqualPageable(
            createdDate,
            addedDateTime,
            cassandraPageRequest
        );
    ...
    public ResponseEntity<List<PostDTO>> findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeGreaterThanPageable(
        @RequestParam(name = "createdDate", required = true) final Long createdDate,
        @RequestParam(name = "addedDateTime", required = true) final Long addedDateTime,
        @RequestParam(name = "pagingState", required = false) String pagingState,
        @RequestParam(name = "size", defaultValue = "20") int size
        ...
        Slice<PostDTO> slice = postService.findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeGreaterThanPageable(
            createdDate,
            addedDateTime,
            cassandraPageRequest
        );
    ...
    public List<PostDTO> findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeGreaterThanEqual(
        @RequestParam(name = "createdDate", required = true) final Long createdDate,
        @RequestParam(name = "addedDateTime", required = true) final Long addedDateTime
    ) {
        // Composite Primary Key Code
        LOG.debug(
            "REST request to findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeGreaterThanEqual method for Posts with parameteres createdDate: {}, addedDateTime: {}",
            createdDate,
            addedDateTime
        );
        return postService.findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeGreaterThanEqual(createdDate, addedDateTime);
    }
    ...
    public ResponseEntity<List<PostDTO>> findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeGreaterThanEqualPageable(
        @RequestParam(name = "createdDate", required = true) final Long createdDate,
        @RequestParam(name = "addedDateTime", required = true) final Long addedDateTime,
        @RequestParam(name = "pagingState", required = false) String pagingState,
        @RequestParam(name = "size", defaultValue = "20") int size
        ...
        Slice<PostDTO> slice = postService.findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeGreaterThanEqualPageable(
            createdDate,
            addedDateTime,
            cassandraPageRequest
        );
