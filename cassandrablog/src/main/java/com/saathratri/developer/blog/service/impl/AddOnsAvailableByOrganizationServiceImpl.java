...
public class AddOnsAvailableByOrganizationServiceImpl implements AddOnsAvailableByOrganizationService {
    ...
    @Override
    public Slice<AddOnsAvailableByOrganizationDTO> findAllSlice(org.springframework.data.domain.Pageable pageable) {
        LOG.debug("Request to get a slice of AddOnsAvailableByOrganizations");
        return addOnsAvailableByOrganizationRepository.findAll(pageable).map(addOnsAvailableByOrganizationMapper::toDto);
    }
    ...
    @Override
    public Slice<AddOnsAvailableByOrganizationDTO> findAllByCompositeIdOrganizationIdPageable(
        final UUID organizationId,
        Pageable pageable
    ) {
        LOG.debug(
            "Request to findAllByCompositeIdOrganizationIdPageable service in AddOnsAvailableByOrganizationServiceImpl with pagination."
        );
        return addOnsAvailableByOrganizationRepository
    ...
    @Override
    public Slice<AddOnsAvailableByOrganizationDTO> findAllByCompositeIdOrganizationIdAndCompositeIdEntityTypePageable(
        final UUID organizationId,
        final String entityType,
        Pageable pageable
    ) {
        LOG.debug(
            "Request to findAllByCompositeIdOrganizationIdAndCompositeIdEntityTypePageable service in AddOnsAvailableByOrganizationServiceImpl with pagination."
        );
        return addOnsAvailableByOrganizationRepository
    ...
    @Override
    public Slice<AddOnsAvailableByOrganizationDTO> findAllByCompositeIdOrganizationIdAndCompositeIdEntityTypeAndCompositeIdEntityIdPageable(
        final UUID organizationId,
        final String entityType,
        final UUID entityId,
        Pageable pageable
        ...
        LOG.debug(
            "Request to findAllByCompositeIdOrganizationIdAndCompositeIdEntityTypeAndCompositeIdEntityIdPageable service in AddOnsAvailableByOrganizationServiceImpl with pagination."
        );
        return addOnsAvailableByOrganizationRepository
