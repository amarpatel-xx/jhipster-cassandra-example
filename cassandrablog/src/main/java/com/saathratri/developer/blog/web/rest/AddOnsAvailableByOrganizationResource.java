...
public class AddOnsAvailableByOrganizationResource {
    ...
    private static final String ENTITY_NAME = "cassandrablogAddOnsAvailableByOrganization";
    ...
    /**
     * {@code GET  /add-ons-available-by-organizations/slice} : get addOnsAvailableByOrganizations with Cassandra cursor-based pagination.
     *
     ...
     */
    @GetMapping("/slice")
    public ResponseEntity<List<AddOnsAvailableByOrganizationDTO>> getAllAddOnsAvailableByOrganizationsSlice(
        @RequestParam(name = "pagingState", required = false) String pagingState,
        @RequestParam(name = "size", defaultValue = "20") int size
    ) {
        LOG.debug("REST request to get a slice of AddOnsAvailableByOrganizations, pagingState: {}, size: {}", pagingState, size);
        ...
        Slice<AddOnsAvailableByOrganizationDTO> slice = addOnsAvailableByOrganizationService.findAllSlice(cassandraPageRequest);
        List<AddOnsAvailableByOrganizationDTO> result = slice.getContent();
    ...
    public ResponseEntity<List<AddOnsAvailableByOrganizationDTO>> findAllByCompositeIdOrganizationIdPageable(
        @RequestParam(name = "organizationId", required = true) final UUID organizationId,
        @RequestParam(name = "pagingState", required = false) String pagingState,
        @RequestParam(name = "size", defaultValue = "20") int size
    ) {
        LOG.debug(
            "REST request to get paginated AddOnsAvailableByOrganizations with parameters organizationId: {}, pagingState: {}, size: {}",
            organizationId,
            pagingState,
            size
        );
        ...
        if (pagingState == null || pagingState.isEmpty()) {
            ...
            try {
                ...
                LOG.error("Invalid paging state for AddOnsAvailableByOrganizations", e);
                cassandraPageRequest = CassandraPageRequest.first(size);
            }
        }

        Slice<AddOnsAvailableByOrganizationDTO> slice = addOnsAvailableByOrganizationService.findAllByCompositeIdOrganizationIdPageable(
            organizationId,
        ...
        if (hasNext && nextPagingState == null) {
            try {
                ...
                LOG.warn("Unable to resolve next paging state for AddOnsAvailableByOrganizations", e);
            }
        }
    ...
    public ResponseEntity<List<AddOnsAvailableByOrganizationDTO>> findAllByCompositeIdOrganizationIdAndCompositeIdEntityTypePageable(
        @RequestParam(name = "organizationId", required = true) final UUID organizationId,
        @RequestParam(name = "entityType", required = true) final String entityType,
        @RequestParam(name = "pagingState", required = false) String pagingState,
        @RequestParam(name = "size", defaultValue = "20") int size
        ...
        LOG.debug(
            "REST request to get paginated AddOnsAvailableByOrganizations with parameters organizationId: {}, entityType: {}, pagingState: {}, size: {}",
            organizationId,
            entityType,
            pagingState,
            size
        ...
        Slice<AddOnsAvailableByOrganizationDTO> slice =
            addOnsAvailableByOrganizationService.findAllByCompositeIdOrganizationIdAndCompositeIdEntityTypePageable(
                organizationId,
                entityType,
                cassandraPageRequest
            );
    ...
    public ResponseEntity<
        List<AddOnsAvailableByOrganizationDTO>
    > findAllByCompositeIdOrganizationIdAndCompositeIdEntityTypeAndCompositeIdEntityIdPageable(
        ...
        LOG.debug(
            "REST request to get paginated AddOnsAvailableByOrganizations with parameters organizationId: {}, entityType: {}, entityId: {}, pagingState: {}, size: {}",
            organizationId,
            entityType,
            entityId,
            pagingState,
        ...
        Slice<AddOnsAvailableByOrganizationDTO> slice =
            addOnsAvailableByOrganizationService.findAllByCompositeIdOrganizationIdAndCompositeIdEntityTypeAndCompositeIdEntityIdPageable(
                organizationId,
                entityType,
                entityId,
                cassandraPageRequest
