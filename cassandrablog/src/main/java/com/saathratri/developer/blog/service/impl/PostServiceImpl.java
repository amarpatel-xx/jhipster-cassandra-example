...
public class PostServiceImpl implements PostService {
    ...
    @Override
    public Slice<PostDTO> findAllByCompositeIdCreatedDatePageable(final Long createdDate, Pageable pageable) {
        LOG.debug("Request to findAllByCompositeIdCreatedDatePageable service in PostServiceImpl with pagination.");
        return postRepository.findAllByCompositeIdCreatedDate(createdDate, pageable).map(postMapper::toDto);
    }
    ...
    @Override
    public Slice<PostDTO> findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimePageable(
        final Long createdDate,
        final Long addedDateTime,
        Pageable pageable
    ) {
        LOG.debug(
            "Request to findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimePageable service in PostServiceImpl with pagination."
        );
        return postRepository
    ...
    @Override
    public Slice<PostDTO> findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeLessThanPageable(
        final Long createdDate,
        final Long addedDateTime,
        Pageable pageable
    ) {
        LOG.debug(
            "Request to findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeLessThanPageable service in PostServiceImpl with pagination."
        );
        return postRepository
    ...
    public List<PostDTO> findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeLessThanEqual(
        ...
        LOG.debug(
            "Request to findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeLessThanEqual(final Long createdDate, final Long addedDateTime) service in PostServiceImpl."
        );
        return postRepository
    ...
    @Override
    public Slice<PostDTO> findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeLessThanEqualPageable(
        final Long createdDate,
        final Long addedDateTime,
        Pageable pageable
    ) {
        LOG.debug(
            "Request to findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeLessThanEqualPageable service in PostServiceImpl with pagination."
        );
        return postRepository
    ...
    @Override
    public Slice<PostDTO> findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeGreaterThanPageable(
        final Long createdDate,
        final Long addedDateTime,
        Pageable pageable
    ) {
        LOG.debug(
            "Request to findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeGreaterThanPageable service in PostServiceImpl with pagination."
        );
        return postRepository
    ...
    public List<PostDTO> findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeGreaterThanEqual(
        ...
        LOG.debug(
            "Request to findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeGreaterThanEqual(final Long createdDate, final Long addedDateTime) service in PostServiceImpl."
        );
        return postRepository
    ...
    @Override
    public Slice<PostDTO> findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeGreaterThanEqualPageable(
        final Long createdDate,
        final Long addedDateTime,
        Pageable pageable
    ) {
        LOG.debug(
            "Request to findAllByCompositeIdCreatedDateAndCompositeIdAddedDateTimeGreaterThanEqualPageable service in PostServiceImpl with pagination."
        );
        return postRepository
