...
public interface SaathratriEntity4Repository extends CassandraRepository<SaathratriEntity4, SaathratriEntity4Id> {
    ...
    Slice<SaathratriEntity4> findAllByCompositeIdOrganizationId(final UUID organizationId, Pageable pageable);
    Optional<SaathratriEntity4> findByCompositeIdOrganizationIdAndCompositeIdAttributeKey(
