...
describe('Tag Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '98ee8ea3-644a-40e1-a41d-945852ec36b4' }], {
    ...
    expect(comp.tags()[0]).toEqual(expect.objectContaining({ id: '98ee8ea3-644a-40e1-a41d-945852ec36b4' }));
  });

  describe('trackId', () => {
    it('should forward to tagService', () => {
      const entity = { id: '98ee8ea3-644a-40e1-a41d-945852ec36b4' };
      vitest.spyOn(service, 'getTagIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.tagsParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
