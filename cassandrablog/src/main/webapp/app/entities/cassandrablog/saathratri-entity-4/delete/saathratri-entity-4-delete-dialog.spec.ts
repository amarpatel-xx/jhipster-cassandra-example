...
import { SaathratriEntity4DeleteDialog } from './saathratri-entity-4-delete-dialog';

describe('SaathratriEntity4 Management Delete Component', () => {
  let comp: SaathratriEntity4DeleteDialog;
  let fixture: ComponentFixture<SaathratriEntity4DeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SaathratriEntity4DeleteDialog);
