...
const saathratriEntity4Route: Routes = [
  {
    path: '',
    loadComponent: () => import('./list/saathratri-entity-4').then(m => m.SaathratriEntity4Component),
    data: {},
    canActivate: [UserRouteAccessService],
  },
  {
    path: ':organizationId/:attributeKey/view',
    loadComponent: () => import('./detail/saathratri-entity-4-detail').then(m => m.SaathratriEntity4DetailComponent),
    resolve: {
  ...
  {
    path: 'new',
    loadComponent: () => import('./update/saathratri-entity-4-update').then(m => m.SaathratriEntity4UpdateComponent),
    resolve: {
      saathratriEntity4: SaathratriEntity4Resolve,
    },
    canActivate: [UserRouteAccessService],
