...
export class TajUserComponent implements OnInit {
  ...
  readonly isLoading = this.tajUserService.tajUsersResource.isLoading;
  ...
  constructor() {
    effect(() => {
      this.tajUsers.set(this.fillComponentAttributesFromResponseBody([...this.tajUserService.tajUsers()]));
    });
  }
  ...
  protected fillComponentAttributesFromResponseBody(data: ITajUser[]): ITajUser[] {
  ...
  protected queryBackend(): void {
    ...
    this.tajUserService.tajUsersParams.set(queryObject);
  }
