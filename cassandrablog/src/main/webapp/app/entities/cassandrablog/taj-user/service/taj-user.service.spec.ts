...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../taj-user.test-samples';
  ...
  describe('Service methods', () => {
    ...
    describe('addTajUserToCollectionIfMissing', () => {
      it('should add a TajUser to an empty array', () => {
        ...
        expect(expectedResult).toEqual([tajUser]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([tajUser, tajUser2]);
      });
