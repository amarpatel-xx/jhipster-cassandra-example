...
import { TajUserComponent } from './taj-user';

describe('TajUser Management Component', () => {
  let comp: TajUserComponent;
  let fixture: ComponentFixture<TajUserComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TajUserComponent);
