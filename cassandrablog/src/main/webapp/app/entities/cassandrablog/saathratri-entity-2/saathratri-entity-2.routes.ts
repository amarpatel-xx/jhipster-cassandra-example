...
const saathratriEntity2Route: Routes = [
  {
    path: '',
    loadComponent: () => import('./list/saathratri-entity-2').then(m => m.SaathratriEntity2Component),
    data: {},
    canActivate: [UserRouteAccessService],
  },
  {
    path: ':entityTypeId/:yearOfDateAdded/:arrivalDate/:blogId/view',
    loadComponent: () => import('./detail/saathratri-entity-2-detail').then(m => m.SaathratriEntity2DetailComponent),
    resolve: {
  ...
  {
    path: 'new',
    loadComponent: () => import('./update/saathratri-entity-2-update').then(m => m.SaathratriEntity2UpdateComponent),
    resolve: {
      saathratriEntity2: SaathratriEntity2Resolve,
    },
    canActivate: [UserRouteAccessService],
