...
describe('SaathratriEntity2 Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a SaathratriEntity2', () => {
      ...
      service.create(saathratriEntity2).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a SaathratriEntity2', () => {
      ...
      service.update(saathratriEntity2).subscribe(resp => (expectedResult = resp));
    ...
    describe('addSaathratriEntity2ToCollectionIfMissing', () => {
      it('should add a SaathratriEntity2 to an empty array', () => {
        ...
        expect(expectedResult).toEqual([saathratriEntity2]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([saathratriEntity2, saathratriEntity22]);
      });
    ...
    describe('compareSaathratriEntity2', () => {
      ...
      it('should return false if one entity is null', () => {
        const entity1 = { entityTypeId: '478effd9-630b-455d-b46d-efa51cd24482' };
        const entity2 = null;
      ...
      it('should return false if primaryKey differs', () => {
        const entity1 = { entityTypeId: '478effd9-630b-455d-b46d-efa51cd24482' };
        const entity2 = { entityTypeId: '6d1fa154-3bf3-4062-a599-7451256404c9' };
      ...
      it('should return false if primaryKey matches', () => {
        const entity1 = { entityTypeId: '478effd9-630b-455d-b46d-efa51cd24482' };
        const entity2 = { entityTypeId: '478effd9-630b-455d-b46d-efa51cd24482' };
