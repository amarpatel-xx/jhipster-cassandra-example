...
describe('Blog Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ category: 'd97e55e3-ad93-4a91-b761-e2d09b7c888e' }], {
  ...
  describe('trackCategory', () => {
    it('should forward to blogService', () => {
      ...
      vitest.spyOn(service, 'getBlogIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.blogsParams()).toMatchObject(expect.objectContaining({ sort: ['category,desc'] }));
  });
