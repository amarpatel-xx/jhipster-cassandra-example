...
const addOnsAvailableByOrganizationRoute: Routes = [
  {
    path: '',
    loadComponent: () => import('./list/add-ons-available-by-organization').then(m => m.AddOnsAvailableByOrganizationComponent),
    data: {},
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./detail/add-ons-available-by-organization-detail').then(m => m.AddOnsAvailableByOrganizationDetailComponent),
    resolve: {
  ...
  },
  {
    path: 'new',
    loadComponent: () =>
      import('./update/add-ons-available-by-organization-update').then(m => m.AddOnsAvailableByOrganizationUpdateComponent),
    resolve: {
      addOnsAvailableByOrganization: AddOnsAvailableByOrganizationResolve,
    },
    canActivate: [UserRouteAccessService],
