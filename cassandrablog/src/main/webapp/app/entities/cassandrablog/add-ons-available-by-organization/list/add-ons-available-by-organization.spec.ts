...
import { AddOnsAvailableByOrganization } from './add-ons-available-by-organization';

vitest.useFakeTimers();

describe('AddOnsAvailableByOrganization Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: AddOnsAvailableByOrganization;
  let fixture: ComponentFixture<AddOnsAvailableByOrganization>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AddOnsAvailableByOrganization);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ organizationId: 'fe29463b-6ce7-4f08-add6-0cd21f742c31' }], {
  ...
  describe('trackOrganizationId', () => {
    it('should forward to addOnsAvailableByOrganizationService', () => {
      ...
      vitest.spyOn(service, 'getAddOnsAvailableByOrganizationIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.addOnsAvailableByOrganizationsParams()).toMatchObject(expect.objectContaining({ sort: ['organizationId,desc'] }));
  });
