...
describe('SaathratriEntity Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a SaathratriEntity', () => {
      ...
      service.create(saathratriEntity).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a SaathratriEntity', () => {
      ...
      service.update(saathratriEntity).subscribe(resp => (expectedResult = resp));
    ...
    describe('addSaathratriEntityToCollectionIfMissing', () => {
      it('should add a SaathratriEntity to an empty array', () => {
        ...
        expect(expectedResult).toEqual([saathratriEntity]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([saathratriEntity, saathratriEntity2]);
      });
    ...
    describe('compareSaathratriEntity', () => {
      ...
      it('should return false if one entity is null', () => {
        const entity1 = { entityId: '9a32a2a5-a4ff-46ed-920e-fb61b74090d3' };
        const entity2 = null;
      ...
      it('should return false if primaryKey differs', () => {
        const entity1 = { entityId: '9a32a2a5-a4ff-46ed-920e-fb61b74090d3' };
        const entity2 = { entityId: '2589838d-5669-48e1-9d61-31ea9ddc57c7' };
      ...
      it('should return false if primaryKey matches', () => {
        const entity1 = { entityId: '9a32a2a5-a4ff-46ed-920e-fb61b74090d3' };
        const entity2 = { entityId: '9a32a2a5-a4ff-46ed-920e-fb61b74090d3' };
