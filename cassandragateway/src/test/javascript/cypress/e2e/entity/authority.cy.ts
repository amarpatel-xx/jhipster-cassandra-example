...
describe('Authority e2e test', () => {
  ...
  let username: string;
  let password: string;
  const authoritySample = { name: '691baecb-8326-41fc-90b6-6f12f0522ad2' };
  ...
  describe('Authority page', () => {
    it('should have translated page title', () => {
      ...
      cy.getEntityHeading('Authority').should('not.contain', 'cassandragatewayApp.adminAuthority.home.title');
    });
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('4bc7a933-8c5f-479e-bb7e-d166c6cf9003');
      cy.get(`[data-cy="name"]`).should('have.value', '4bc7a933-8c5f-479e-bb7e-d166c6cf9003');
