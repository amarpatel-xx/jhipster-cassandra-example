...
import com.saathratri.developer.gateway.repository.AuthorityRepository;
import com.saathratri.developer.gateway.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.saathratri.developer.gateway.domain.Authority}.
 */
@RestController
...
public class AuthorityResource {
    ...
    @Value("${jhipster.clientApp.name:cassandragateway}")
