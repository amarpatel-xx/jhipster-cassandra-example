...
To build the final jar and optimize the cassandragateway application for production, run:
...
- [Doing microservices with JHipster](https://www.jhipster.tech/documentation-archive/v9.1.0/microservices-architecture/)
...
- [Service Discovery and Configuration with the JHipster-Registry](https://www.jhipster.tech/documentation-archive/v9.1.0/microservices-architecture/#jhipster-registry)
