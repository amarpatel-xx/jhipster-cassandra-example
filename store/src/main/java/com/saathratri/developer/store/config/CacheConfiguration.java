...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance existingInstance = Hazelcast.getHazelcastInstanceByName("store");
        ...
        config.setClusterName("store-cluster");
        ...
        if (env.acceptsProfiles(Profiles.of(JHipsterConstants.SPRING_PROFILE_DEVELOPMENT))) {
            ...
            networkConfig.setPort(serverProperties.getPort() + 5701);
            joinConfig.getTcpIpConfig().setEnabled(false); // No clustering
    ...
    private MapConfig initializeDomainMapConfig(JHipsterProperties jHipsterProperties) {
        MapConfig mapConfig = new MapConfig("com.saathratri.developer.store.domain.*");
